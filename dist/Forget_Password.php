            ...
            <div class="flex flex-wrap -mx-3">
              ...
              <?php include "../includes/db.php";
                  if(isset($_GET['message']) && !empty(trim($_GET['message']))){
                    ...
                    if($message == "success"){
                      $message = "Email sended successfully, Check your email";
                ...
                >
                  <div class="p-6 pb-0 mb-0">
                    <h4 class="font-bold gg" style="color: white;">Forget Password?</h4>
                    <p class="mb-0 gg" style="color: #f1f1f1;">Enter your email to reset your password</p>
                  </div>
