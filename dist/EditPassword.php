    ...
    <div class="home">
      ...
      <div class="sidebar">
        <div class="Categories">
          <h2>Edit Password</h2>
          <div class="category">
            <form action="../../includes/updatePassword.php" method="post" enctype="multipart/form-data" class="userForm">
              <div class="content">
                <div class="user-details">
                  <div class="input-box">
                    <label class="details">Enter Current Password</label>
                    <input type="password" name="PrePassword" placeholder="Current Password" id="myInput" required minlength="8">
                  </div>
                  <div class="input-box">
                    <label class="details">Enter New Password</label>
                    <input type="password" name="Password" placeholder="New Password" id="myInput" required minlength="8">
                  </div>
                  <div class="input-box">
                  ...
                  <div class="UserButtons">
                    <input class="button" type="submit" name="submit" value="Update Password" style="width: -webkit-fill-available;">
                  </div>
                </div>
              </div>
            </form>
