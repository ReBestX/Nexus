  ...
  <div class="container">
    <div class="home">
      <div class="posts">
        ...
        $query = "SELECT * FROM posts WHERE post_status = 'published' LIMIT $startFrom, $postsPerPage";
        ...
        while ($row = mysqli_fetch_assoc($select_all_posts_query)) {
            ...
            echo "<div class='post'>
                        ...
                        <div class='content skeleton'><p class='responsive-content'>{$postContent}</p></div>
        ...
        <div class="pre-next">
            ...
            for ($i = 1; $i <= $pages; $i++) {
                ...
                echo "<button class='$activeClass'><a href='../index/{$i}'>{$i}</a></button>";
            }
            ?>
        </div>
      </div>
