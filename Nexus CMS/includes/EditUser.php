...
if (isset($_POST["submit"])) {
  ...
  while ($row = mysqli_fetch_assoc($result2)) {
    ...
    if($user_Username == $Username){
      ...
      header("Location: ../dist/users.php?error=$em");
      exit;
    }
  }
  ...
  $query = "UPDATE users SET user_firstname = '{$user_firstName}', user_lastname = '{$user_lastName}', user_username = '{$user_Username}', user_email = '{$user_email}', user_role = '{$user_role}', user_image = '{$user_image}' WHERE user_id = $user_id";
